          ...
          :to="`/rest?id=${rest.id}`" >
            ...
            <div class="products-card__desc">
              <div class="products-card__desc-row">
                <h4 class="products-card__desc--title">{{ rest.title }}</h4>
                <div class="products-card__desc--badge">{{ rest.time }}</div>
              </div>
              <div class="products-card__desc-row">
                <div class="products-card__desc-info">
                  <div class="products-card__desc-info--raiting">
                    <img src="../assets/images/icons/star.svg" alt="star">{{ rest.rating }}
                  </div>
                  <div class="products-card__desc-info--price">От {{ rest.price }} Р</div>
                  <div class="products-card__desc-info--group">{{ rest.type }}</div>
                </div>
              </div>
            </div>
          </router-link>
...
<script setup>
  ...
  const getUrl = (name) => {return new URL(`../assets/images/rests/${name}`, import.meta.url)}
</script>